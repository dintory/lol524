...
library.theme = {
    ...
    bordercolor = Color3.fromRGB(69,0,0),
    accentcolor = Color3.fromRGB(69,0,0),
    accentcolor2 = Color3.fromRGB(69,0,0),
    outlinecolor = Color3.fromRGB(69,0,0),
...
function library:CreateWatermark(name)
    ...
    watermark.mainbar.BorderColor3 = Color3.fromRGB(69,0,0)
